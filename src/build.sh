...
out=h+open('engine.js',encoding='utf-8').read()+open('view3d.js',encoding='utf-8').read()+open('cloud.js',encoding='utf-8').read()+open('quiz.js',encoding='utf-8').read()+open('app.js',encoding='utf-8').read()+'</script>\n</body>\n</html>\n'
